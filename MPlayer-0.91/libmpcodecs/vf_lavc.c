...
static int config(struct vf_instance_s* vf,
	...
	case 240:
	case 480:
	    lavc_venc_context.frame_rate=29.97*DEFAULT_FRAME_RATE_BASE; // NTSC
	    break;
	case 576:
	case 288:
	default:
	    lavc_venc_context.frame_rate=25*DEFAULT_FRAME_RATE_BASE; // PAL
	    break;
...
static int open(vf_instance_t *vf, char* args){
    ...
    lavc_venc_context.frame_rate = (p_fps<1.0) ? 0 : (p_fps * DEFAULT_FRAME_RATE_BASE);
