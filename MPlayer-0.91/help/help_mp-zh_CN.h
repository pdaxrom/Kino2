...
"  - 试试-nocache\n"\
"阅读DOCS/Chinese/video.html和DOCS/Chinese/sound.html来寻找调整/加速的技巧。\n"\
"如果这些一个都用不上，阅读DOCS/Chinese/bugreports.html！\n\n"
...
"  请阅读DOCS/Chinese/bugreports.html\n"
...
"  反汇编。具体细节看DOCS/Chinese/bugreports.html#crash.b.\n"
#define MSGTR_Exit_SIGCRASH \
"- MPlayer崩溃了。这不应该发生。\n"\
"  这可能是MPlayer代码中的 _或者_ 你的驱动中的 _or_ 你的gcc的\n"\
"  一个bug。如果你觉得这是MPlayer的错，请阅读DOCS/Chinese/bugreports.html\n"\
...
#define MSGTR_EncryptedVOB "加密的VOB文件(没有编译libcss支持)! 阅读DOCS/Chinese/cd-dvd.html.\n"
