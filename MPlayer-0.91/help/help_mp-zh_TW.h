// Sync'ed on 2003-07-26 with help_mp-en.h 1.95
...
"  - 可試試 -nocache。\n"\
"要取得調整/加速的秘訣請參閱 DOCS/Chinese/video.html 與 DOCS/Chinese/sound.html。\n"\
"假如以上沒一個幫得上，請參閱 DOCS/Chinese/bugreports.html。\n\n"
...
"  請參閱 DOCS/Chinese/bugreports.html。\n"
...
"  disassembly。具體細節請參閱 DOCS/Chinese/bugreports.html#crash.b。\n"
#define MSGTR_Exit_SIGCRASH \
"- MPlayer 當了。 這是不應該發生的。\n"\
"  這可能是在 MPlayer 程式碼 _或者_ 你的驅動程式 _或者_ 你的 gcc 版本\n"\
"  中有臭蟲 version。假如你認為是 MPlayer 的毛病，請參閱 \n"\
"  DOCS/Chinese/bugreports.html 並跟從其步驟。除非你在報告懷疑是臭蟲時能提供這\n"\
"  些資料，否則我們將無法及不會幫忙。\n"
...
#define MSGTR_EncryptedVOB "已加密的 VOB 檔 (並無 libcss 支援)﹗請參閱 DOCS/Chinese/cd-dvd.html。\n"
