/*
 *	ATI Imageon 100 (W100) Vidix driver
 *	(с) Sasha Chukov <sash@cacko.biz>
 *
 *	06.09.03 Исправлен (баг?) неправильный вывод на экран при 320x240 разрешении
 *		 при положении оверлейного окна в позиции X=0
 *	03.09.03 Первая версия драйвера написанного по мотивам MoviePlayer...
 *
 *
 */
 ...
 */
    ...
    AtiCore_SetOverlayPos(g_overlayHandle, info->dest.x + 4, info->dest.y);
